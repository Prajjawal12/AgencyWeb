    ...
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-center">
            AgencyWeb
          </h1>
        </div>
        <div className="flex justify-center items-center relative mt-4 md:mt-[-10px]">
          <Image
          ...
          />
          <div className="absolute bottom-0 top-[50%] bg-gradient-to-t dark:from-background left-0 right-0"></div>
        </div>
      </section>
      <section className="flex justify-center items-center flex-col gap-4 mt-20 lg:mt-40">
